...
jalan('\033[1;93m              Welcome to MR DANISH')
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #Dev:MR-DANISH
        ...
        os.system('xdg-open https://m.facebook.com/DANISH')
...
def login():
	...
	try:
		...
		try:
			...
			br.open('https://www.facebook.com/MuhammadDanishLOVER')
...
def pilih_super():
	...
	print "\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mMR _DANISH\033[1;96m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"

	print "  \033[1;93m«---•◈•---Developed By MR DANISH--•◈•---»" #Dev:MR DANISH
...
(__)`--' |_|  (_)/(  (_)`-' `----'  /(  (_) 
                ...
                (__)               (__)     
                       ...
                       Checkpoint ID Open MRD______ _____  _____ _____ _____
...
: \033[1;96m .... MR DANISH....... \033[1;93m :

•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 

                WhatsApp Num

              \033[1;96m 03491120866🙈🙄🙄""
